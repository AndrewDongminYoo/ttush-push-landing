...
| Missing                     | Why                                                                                                                                                                                                                                                                            |
| --------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Store links and `/download` | Google Play is in closed testing on the way to production, and the App Store submission is in review. Neither store has a public page, so both links would 404 and `lib/site.ts` exports `null` instead of guessing a URL.                                                     |
